...
using Kit.MAUI.Controls;
using Kit.MAUI.Fonts;
using Kit.MAUI.Services;
...
namespace Kit.MAUI.Pages
{
    ...
    public partial class CadenaCon : BasePage
    {
        ...
        public async Task ShowAndExecute(Kit.Extensions.Command<CadenaCon> Command)
        {
            ...
            await Microsoft.Maui.Controls.Application.Current.MainPage.Navigation.PushModalAsync(this);
        }
        ...
        private void ToogleStatus(Exception ex)
        {
            ...
            LblIcon.TextColor = ex is null ? Colors.Green : Colors.Red;
        }
