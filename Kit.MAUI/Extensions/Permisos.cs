...
namespace Kit.MAUI.Extensions
{
    public static class Permisos
    {
        ...
        public static async Task<bool> TenemosPermiso(Permissions.BasePermission Permiso) => 
            await GetPermissionStatus(Permiso) == PermissionStatus.Granted;
