    ...
    public partial class Lector : ContentView
    {
        ...
        public static readonly BindableProperty OnCodeReadCommandProperty =
            BindableProperty.Create(
              ...
              //defaultValue: new Microsoft.Maui.Command<string>(
        ...
        private void OpenCamera()
        {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
                ...
                {
                    this.INavigation.PushModalAsync(new NavigationPage(Page) { BarTextColor = Colors.White, 
                        BarBackgroundColor = Colors.CadetBlue }, true);
                }
            });
        }
