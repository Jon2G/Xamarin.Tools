...
namespace Kit.MAUI.Controls.CrossImage
{
    public class CrossImageExtensions : Kit.Controls.CrossImage.CrossImageExtensions
    {
        ...
        {
            Kit.MAUI.Controls.CrossImage.CrossImage image = new Kit.MAUI.Controls.CrossImage.CrossImage();
        ...
        public override Task<byte[]> GetByteArray(Kit.Controls.CrossImage.CrossImage CrossImage)
        {
            ...
            return Kit.MAUI.Extensions.ImageExtensions.GetByteArray(streamImageSource);
        }
