...
namespace Kit.MAUI.Controls
{
    ...
    {
        static Color KNOBDEFAULT = Color.FromArgb("F3F3F3");
        static Color ARCCOLORDEFAULT = Colors.ForestGreen;
        static Color ARCBACKGROUNDCOLOR = Color.FromArgb("D3D3D3");
        ...
        #region arc TextColor
        Color _TextColor = TEXTCOLORDEFAULT;
        ...
        void OnCanvasViewPaintSurface(object sender, SKPaintSurfaceEventArgs args)
        {
            ...
            SKPaint KnobPaint = new SKPaint
            {
                ...
                IsAntialias = true,
                ImageFilter = SKImageFilter.CreateDropShadow(0, 0, 3, 3, ArcColor.MultiplyAlpha(.5f).ToSKColor())
