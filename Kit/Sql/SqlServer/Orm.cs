...
namespace Kit.Sql.SqlServer
{
    public static class Orm
    {
        ...
        public static string SqlType(Column p)
        {
            ...
            if (clrType == typeof(Boolean) || clrType == typeof(Byte) || clrType == typeof(UInt16) || clrType == typeof(UInt64) || clrType == typeof(SByte) || clrType == typeof(Int16) || clrType == typeof(Int32) || clrType == typeof(UInt32) || clrType == typeof(Int64))
            {
                return "integer";
            }
