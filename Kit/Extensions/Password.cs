...
namespace Kit.Extensions
{
    public static class Password
    {
        ...
        public static string Generate(int length, int numberOfNonAlphanumericCharacters, bool UseEspecialCharacters = true)
        {
            ...
            {
                return Generate(length, numberOfNonAlphanumericCharacters);
            }
            return GenerateNoSpecialCharacters(length, numberOfNonAlphanumericCharacters);
        }
    }
}