...
{
    public class ValidationEntry : Entry, IControlValidation
    {
        #region Property
        ...
        public static readonly BindableProperty HasErrorProperty =
            BindableProperty.Create("HasError", typeof(bool), typeof(ValidationEntry), false, defaultBindingMode: BindingMode.TwoWay);
        ...
        public static readonly BindableProperty ErrorMessageProperty =
           BindableProperty.Create("ErrorMessage", typeof(string), typeof(ValidationEntry), string.Empty);
        ...
        public static readonly BindableProperty ShowErrorMessageProperty =
           BindableProperty.Create("ShowErrorMessage", typeof(bool), typeof(ValidationEntry), false, propertyChanged: OnShowErrorMessageChanged, defaultBindingMode: BindingMode.TwoWay);
        ...
        private static void OnShowErrorMessageChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            ValidationEntry control = bindable as ValidationEntry;
        ...
        private void NotifyScroll_ScrollToProperty(string PropertyName)
        {
            ...
            {
                // Get scroll 
                ScrollView _scroll =this.FindParent<ScrollView>();
