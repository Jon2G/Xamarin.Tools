...
namespace Plugin.Xamarin.Tools.Shared.Services
{
    public static class ScreenManager
    {
        ...
        /// </summary>
        private static Lazy<Services.Interfaces.IScreenManager> implementation =
            new Lazy<Services.Interfaces.IScreenManager>(Create, System.Threading.LazyThreadSafetyMode.PublicationOnly);

        /// <summary>
        /// Current file picker plugin implementation to use
        /// </summary>
        public static Services.Interfaces.IScreenManager Current
        {
            get
            {
        ...
        private static Services.Interfaces.IScreenManager Create()
        {
